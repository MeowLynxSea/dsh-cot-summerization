...
function Field({ label, hint, children }) {
    return (_jsxs("label", { className: "dshc-field", children: [_jsx("span", { className: "dshc-field-label", children: label }), children, hint !== undefined && _jsx("span", { className: "dshc-field-hint", children: hint })] }));
}
...
function SettingsSection({ scope, t }) {
    ...
    useEffect(() => () => { if (savedTimer.current !== undefined)
    ...
    if (snapshot.status === 'unavailable')
        return _jsx("p", { children: t('unavailable') });
    ...
    return (_jsxs("section", { className: "dshc-section", children: [_jsxs("div", { className: "dshc-head", children: [_jsx("h3", { children: t('settingsTitle') }), _jsx("p", { children: t('settingsIntro') })] }), _jsxs("div", { className: "dshc-grid", children: [_jsxs(Field, { label: t('enabled'), children: [_jsx("input", { type: "checkbox", checked: value.enabled ?? true, onChange: (event) => { save('enabled', event.target.checked); } }), mark('enabled') !== undefined && _jsx("span", { className: "dshc-saved", children: mark('enabled') })] }), _jsxs(Field, { label: t('baseUrl'), hint: t('baseUrlHint'), children: [_jsx("input", { type: "text", defaultValue: value.baseUrl ?? '', onBlur: (event) => { if (event.target.value.trim() !== '')
                                    save('baseUrl', event.target.value.trim()); } }), mark('baseUrl') !== undefined && _jsx("span", { className: "dshc-saved", children: mark('baseUrl') })] }), _jsxs(Field, { label: t('apiKey'), hint: t('apiKeyHint'), children: [_jsx("input", { type: "password", defaultValue: value.apiKey ?? '', onBlur: (event) => { if (event.target.value !== '')
                                    save('apiKey', event.target.value); } }), mark('apiKey') !== undefined && _jsx("span", { className: "dshc-saved", children: mark('apiKey') })] }), _jsxs(Field, { label: t('model'), hint: t('modelHint'), children: [_jsx("input", { type: "text", defaultValue: value.model ?? '', onBlur: (event) => { if (event.target.value.trim() !== '')
                                    save('model', event.target.value.trim()); } }), mark('model') !== undefined && _jsx("span", { className: "dshc-saved", children: mark('model') })] }), _jsxs(Field, { label: t('systemPrompt'), hint: t('systemPromptHint'), children: [_jsx("textarea", { rows: 5, defaultValue: value.systemPrompt ?? '', onBlur: (event) => { if (event.target.value.trim() !== '')
                                    save('systemPrompt', event.target.value); } }), mark('systemPrompt') !== undefined && _jsx("span", { className: "dshc-saved", children: mark('systemPrompt') })] }), _jsxs(Field, { label: t('minReasoningChars'), hint: t('minReasoningCharsHint'), children: [_jsx("input", { type: "number", min: 0, defaultValue: value.minReasoningChars ?? 32, onBlur: (event) => {
                                    const parsed = Number(event.target.value);
                                    if (Number.isFinite(parsed) && parsed >= 0)
                                        save('minReasoningChars', parsed);
                                } }), mark('minReasoningChars') !== undefined && _jsx("span", { className: "dshc-saved", children: mark('minReasoningChars') })] }), _jsxs(Field, { label: t('maxSummaryChars'), hint: t('maxSummaryCharsHint'), children: [_jsx("input", { type: "number", min: 1, defaultValue: value.maxSummaryChars ?? 800, onBlur: (event) => {
                                    const parsed = Number(event.target.value);
                                    if (Number.isFinite(parsed) && parsed >= 1)
                                        save('maxSummaryChars', parsed);
                                } }), mark('maxSummaryChars') !== undefined && _jsx("span", { className: "dshc-saved", children: mark('maxSummaryChars') })] }), _jsxs(Field, { label: t('timeoutMs'), children: [_jsx("input", { type: "number", min: 1, defaultValue: value.timeoutMs ?? 30000, onBlur: (event) => {
                                    const parsed = Number(event.target.value);
                                    if (Number.isFinite(parsed) && parsed >= 1)
                                        save('timeoutMs', parsed);
                                } }), mark('timeoutMs') !== undefined && _jsx("span", { className: "dshc-saved", children: mark('timeoutMs') })] }), _jsxs(Field, { label: t('onError'), children: [_jsxs("select", { defaultValue: value.onError ?? 'hide', onChange: (event) => { save('onError', event.target.value); }, children: [_jsx("option", { value: "hide", children: t('onErrorHide') }), _jsx("option", { value: "pass-through", children: t('onErrorPassThrough') })] }), mark('onError') !== undefined && _jsx("span", { className: "dshc-saved", children: mark('onError') })] })] })] }));
}
const STYLES = `
