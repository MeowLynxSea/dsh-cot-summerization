		...
		*/
		function Field({ label, hint, inline = false, children }) {
			if (inline) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "dshc-field dshc-field-inline",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "dshc-field-text",
		...
		function SettingsSection({ t }) {
			...
			const [showSaved, setShowSaved] = (0, react.useState)(false);
			/**
			...
			*/
			...
			(0, react.useEffect)(() => {
				...
				return () => {
					if (state.debounce !== void 0) clearTimeout(state.debounce);
					if (state.savedTimer !== void 0) clearTimeout(state.savedTimer);
				};
			}, []);
			(0, react.useEffect)(() => {
				let cancelled = false;
			...
			const flushSave = () => {
				...
				saveView(state.revision, { ...draftRef.current }).then((next) => {
			...
			if (!ready) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: error !== void 0 ? `${t("unavailable")} ${error}` : t("loading") });
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Field, {
								label: t("streamReasoningBlock"),
								hint: t("streamReasoningBlockHint"),
								inline: true,
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Switch, {
									checked: draft.streamReasoningBlock ?? true,
									onChange: (checked) => {
										set("streamReasoningBlock", checked);
									}
								})
							}),
							draft.streamReasoningBlock !== false && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Field, {
								label: t("reasoningBlockWaitMs"),
								hint: t("reasoningBlockWaitMsHint"),
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
									type: "number",
									min: 0,
									max: 6e4,
									value: draft.reasoningBlockWaitMs ?? 3e3,
									onChange: (event) => {
										const parsed = Number(event.target.value);
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [saveStatus !== "idle" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "dshc-status",
							children: saveStatus === "saving" ? t("saving") : t("savePending")
						}) : showSaved && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
