...
import { captureReasoningDelta, captureReasoningStart, createRawCapture, createRawHistoryRestorer, } from "./history.js";
 ...
 */
export async function* transformCoTStream(upstream, cfg, summarize, callerSignal, log = () => { }, capture = undefined) {
    let rawCoT = '';
